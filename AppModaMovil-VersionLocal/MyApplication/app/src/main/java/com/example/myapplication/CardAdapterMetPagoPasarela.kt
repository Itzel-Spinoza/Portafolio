...
class CardAdapterMetPagoPasarela (private var cardList: List<MetodosPago>, private val listener: PasarelaPago) :
    RecyclerView.Adapter<CardAdapterMetPagoPasarela.CardViewHolder>() {
