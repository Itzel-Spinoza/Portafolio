    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spinGenero.setOnItemSelectedListener(object : AdapterView.OnItemSelectedListener {
            ...
            override fun onNothingSelected(parentView: AdapterView<*>) {
                // No hacer nada aquí, ya que no es necesario en este caso
            }
        })
        ...
        btnEliminarPrenda.setOnClickListener(View.OnClickListener {
            ...
            conInventarioRopa.eliminarPrenda(this,idPrenda)
        ...
        btnGuardarCambios.setOnClickListener{
            ...
            conInventarioRopa.editarPrenda(this,id,nombrePrenda,talla,catego,genero,descrip,precio,porcentaje,asociacion,donativo)
