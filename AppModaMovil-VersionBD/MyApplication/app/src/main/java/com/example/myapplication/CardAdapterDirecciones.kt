...
class CardAdapterDirecciones(private var cardList: List<Direccion>, private val listener: AgregarDirecciones) :
    RecyclerView.Adapter<CardAdapterDirecciones.CardViewHolder>() {
